                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            <select name="service_id[]" id="service_id" class="form-control" required data-validation-required-message="This field is required" multiple>
                                                <option value="all" {{ request()->query('service_id') ? in_array('all', request()->query('service_id')) ? 'selected' : '' : 'selected' }}>All service</option>
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            <select name="status[]" id="status" class="form-control" required data-validation-required-message="This field is required" multiple>
                                                <option value="all" {{ request()->query('status') ? in_array('all', request()->query('status')) ? 'selected' : '' : 'selected' }}>All status</option>
