        ...
        <div class="col-12">
            <div class="material-card card">
                <div class="card-body">
                    ...
                    <div class="material-card card">
                        <div class="card-body">
                            <form method="post" action="{{ route('reseller.exported_orders.store') }}" novalidate>
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                <select name="provider_ids[]" id="provider_ids" class="form-control select2 @error('provider_ids') is-invalid @enderror" required data-validation-required-message="This field is required" multiple>
                                                    <option value="all" {{ old('provider_ids') ? in_array('all', old('provider_ids')) ? 'selected' : '' : 'selected' }}>All providers</option>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="zero_config" class="table table-striped border table-hover">
                                    ...
                                    <tbody>
                                    @foreach(auth()->guard('reseller')->user()->exportedOrders as $item)
                                    <tr>
                                        <td>{{ $item->from }}</td>
                                        <td>{{ $item->to }}</td>
                                        ...
                                        <td>
                                            <form method="post" action="{{ route('reseller.exported_orders.download', $item->id) }}">
                                                @csrf
