    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-material" method="post" action="{{ route('reseller.profile.update') }}" novalidate>
                    @csrf
                    ...
                    <div class="form-group">
                        <div class="controls">
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Name" value="{{ \Illuminate\Support\Facades\Auth::guard('reseller')->user()->name }}" required data-validation-required-message="This field is required">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-material" method="post" action="{{ route('reseller.email.update') }}" novalidate>
                    @csrf
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-material" method="post" action="{{ route('reseller.profile.password.update') }}" novalidate>
                    @csrf
