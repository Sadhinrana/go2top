...
<head>
    ...
    <title>Go2Top - @yield('title')</title>
                ...
                <ul class="navbar-nav float-right">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <span class="ml-2 user-text font-medium">{{ \Illuminate\Support\Facades\Auth::guard('web')->user()->name }}</span><span class="fas fa-angle-down ml-2 user-text"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                            <div class="d-flex no-block align-items-center p-3 mb-2 border-bottom">
                                <div class=""><img src="../../assets/images/users/1.jpg" alt="user" class="rounded" width="80"></div>
                                <div class="ml-2">
                                    <h4 class="mb-0">{{ \Illuminate\Support\Facades\Auth::guard('web')->user()->name }}</h4>
                                    <p class=" mb-0 text-muted">{{ \Illuminate\Support\Facades\Auth::guard('web')->user()->email }}</p>
    ...
    <aside class="left-sidebar">
        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    <!-- User Profile-->
                    <li class="sidebar-item"> <a class="sidebar-link" href="{{ route('home') }}" aria-expanded="false"><i class="mdi mdi-av-timer"></i><span class="hide-menu">Dashboards </span></a>
                    <li class="sidebar-item"> <a class="sidebar-link" href="{{ route('tickets.index') }}" aria-expanded="false"><i class="mdi mdi-ticket"></i><span class="hide-menu">Tickets </span></a>
                    </li>
                </ul>
            </nav>
